...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "buying")
		void RemoveItem(FName ItemID, bool RemoveItemFromHands, int numOfItemsToRemove);
...
public:
	UFUNCTION(BlueprintCallable, Category = "looking")
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Events")
		FItem GetItemInInventory(FName ItemID);
